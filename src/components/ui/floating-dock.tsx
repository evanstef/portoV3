...
function IconContainer({
  ...
  let widthTransform = useTransform(distance, [-150, 0, 150], [35, 75, 35]);
  let heightTransform = useTransform(distance, [-150, 0, 150], [35, 75, 35]);

  let widthTransformIcon = useTransform(distance, [-150, 0, 150], [15, 35, 15]);
